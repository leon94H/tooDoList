                ...
                <div class="col-12"> --}}
                    ...
                    <form action="{{route('register')}}" method="POST" class="app">
                        ...
                        <div class="mb-3">
                          ...
                          <input name="password" type="password" value="{{old('password')}}" class="form-control @error('password') is-invalid @enderror" id="exampleInputPassword1" aria-describedby="emailHelp">
